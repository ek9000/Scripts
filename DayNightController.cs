...
public class DayNightController : MonoBehaviour
{
	...
	void OnGUI(){
		...
		GUI.Button(new Rect(500, 80, 100, 26), currentPhase.ToString() +" : "+jam+":"+menit);
	}
    ...
    public void SetDay()
    {
        ...
        GetComponent<Skybox>().material = Resources.Load("Material/Sunny_01A_noSun", typeof(Material)) as Material;
        }
	...
	private void UpdateSkyboxBlendFactor(){
        ...
        {
            float relativeTime = currentCycleTime - dawnTime;
			SkyboxBlendFactor = 1 - (relativeTime / quarterDay);
        }
        else if (currentPhase == DayPhase.Day)
        {
        ...
        {
            float relativeTime = currentCycleTime - duskTime;
            SkyboxBlendFactor = relativeTime / quarterDay;
        }
        else if (currentPhase == DayPhase.Night)
        {
